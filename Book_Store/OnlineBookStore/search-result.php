...
<div class="carousel">
	<div id="carouselExampleIndicators" class="carousel slide p-2" data-bs-ride="true">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="images/web-images/user_carousel_images/carousel_c4.jpg" width="100%" height="300px"class="d-block w-100" alt="...">
			</div>
		</div>
				...
				if(isset($_POST['submit']))
				{
					...
					// echo $search_Keyword;
						...
						// pagination
  						...
  						// Fetch Product
  						$sql_product = "select * from tbl_products where product_quantity>0 and product_title='$search_Keyword' limit $skip,$products_on_page";
  						// Execute SQL Query
