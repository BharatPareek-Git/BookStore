	...
	<section class="navbar">
		...
		<div class="navbar-container">
			<ul>
				...
				<li class="navbar-list-item">
					<a href="<?php echo SITEURL; ?>shop.php">Authors</a>
				</li>
				...
				<li class="navbar-list-item">
					...
					<form style="display: inline;" action="<?php echo SITEURL; ?>search-result.php" method="post">
						<input type="text" name="search" placeholder="  Search  " aria-label="Search" aria-describedby="search-addon">
