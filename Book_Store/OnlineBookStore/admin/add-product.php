		...
		<div class="product-div-form">
			...
			<form action="" method="post" enctype="multipart/form-data">
  				<div class="mb-3">
					...
					<label for="select-author" class="form-label">Author</label>
    				<select class="form-select" id="select-category" name="product-auth-id" required>
    					<?php 
    						// Fetch Categories and author id
    						// SQL Query
    						...
    						if($count > 0)
    						{
    							...
    							<option value="0">Select Author</option>
  								...
  								while($row = mysqli_fetch_assoc($res))
  								{
  									...
  									// Display author
  									?>
  									<option value="<?php echo $auth_id; ?>"><?php echo $auth_title; ?></option>
  									<?php
  								}
    						} 
    						else
    						{
    							// Data is Not Available
    							?>
    							<option value="0">Author not Found</option>
    							<?php
...
<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$product_auth_id = $_POST['product-auth-id'];
		$product_image = "";
		...
		$sql2 = "insert into tbl_products (product_title,product_cat_id,product_price,product_quantity,product_short_description,product_description,product_image,auth_id) values('$product_title',$product_cat_id,$product_price,$product_quantity,'$product_short_description','$product_description','$product_image',$product_auth_id)";
